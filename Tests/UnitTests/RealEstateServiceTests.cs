...
namespace Tests.UnitTests
{
    public class RealEstateServiceTests
    {
        ...
        public async Task SearchRealEstateAsync_ReturnsFilteredResults()
        {
            ...
            {
                new RealEstate { Id = Guid.NewGuid(), Title = "Luxury Apartment", Category = ProductCategoryEnum.Residential }
            };
        ...
        public async Task UpdateRealEstateAsync_WithImages_ReturnsSuccess()
        {
            ...
            _mockImageRepository.Setup(x => x.AddAsync(It.IsAny<ProductImage>()))
                .Returns(Task.CompletedTask);
            ...
            _mockImageRepository.Verify(x => x.AddAsync(It.IsAny<ProductImage>()), Times.Once);
        }
        #endregion
        ...
        public async Task DeleteRealEstateAsync_ValidId_ReturnsSuccess()
        {
            ...
            {
                new ProductImage { Id = Guid.NewGuid(), RealEstateId = propertyId }
            };
