...
namespace Infrastructure.Xml.Mappers
{
    public static class XmlRealEstateMapper
    {
        ...
        private static List<ProductImage> GetSafeImages(List<string>? imageUrls, Guid realEstateId)
        {
        ...
        private static ProductCategoryEnum MapCategory(int categoryValue)
        {
            return categoryValue switch
            {
                1 => ProductCategoryEnum.Residential,
                2 => ProductCategoryEnum.Commercial,
                _ => ProductCategoryEnum.Residential // Default
            };
        }
