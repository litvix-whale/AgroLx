...
{
    public class RealEstateImageRepository(AppDbContext context) : RepositoryBase<ProductImage>(context), IRealEstateImageRepository
    {
        public async Task<IEnumerable<ProductImage>> GetImagesByRealEstateIdAsync(Guid realEstateId)
        {
        ...
        public async Task<ProductImage?> GetByRealEstateIdAndPriorityAsync(Guid realEstateId, int priority)
        {
            return await _context.RealEstateImages
